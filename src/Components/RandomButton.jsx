...
const arrayOfPlaneteers = [
	{
		...
		pictureUrl:
			"https://160g7a3snajg2i1r662yjd5r-wpengine.netdna-ssl.com/wp-content/uploads/2019/12/greta.jpg",
...
class RandomButton extends React.Component {
	handleClick = () => {
		const randomPlaneteer =
			arrayOfPlaneteers[
				Math.floor(Math.random() * arrayOfPlaneteers.length)
			];
